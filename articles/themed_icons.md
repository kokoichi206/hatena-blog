...
以下は 2022 年 11 月 18 日の記録です。左が Android 13、右が Android 12 で、中央付近の自作アプリを比較しています。
...
2026 年 9 月 9 日に公式ドキュメントを確認し、Android 16 QPR 2 以降の条件と drawable の説明を更新しました。掲載画像は初回執筆時のものです。自動テーマ化の説明は公式仕様に基づき、今回新しい端末で撮影・比較した結果ではありません。
